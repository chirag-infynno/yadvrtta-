  ...
  return (
    <div>
      ...
      >
        ...
        <div className="pt-[30px] flex mx-auto max-w-2xl gap-10 flex-col px-10">
              ...
              <div className="flex justify-between px-10 borader border-1   border-[#E5E7EB] items-center rounded-[4px]">
                <div className="flex gap-10 ms:h-[38px]  ">
                  ...
                  <input
                    ...
                    className="outline-none lg:w-[203px] md:w-[265px] ms:w-[138px] text-14 "
                  />
                </div>
          ...
          {totalRecords > 0 && (
            <div className="grid sm:grid-cols-2 mt-15 gap-30 md:grid-cols-3 lg:grid-cols-4 ms:grid-cols-1">
