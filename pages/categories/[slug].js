    ...
    <div>
      {showDatepicker && (
        <div className="datepicker opacity-100 ">
          <div className="flex justify-between bg-white mx-1 px-8 pt-4 rounded-t-5">
          ...
          <div className="bg-white px-8 mx-1">
            {dateRange?.startDate &&
          ...
          <div className={classNames("text-center mt-[10px] ")}>
            <button
              className={classNames(
                "p-10  text-white bg-[#23c5ff] rounded-5",
      ...
      >
        ...
        <div className=" flex gap-20 flex-col ">
          ...
          >
            <div className="text-white mt-[100px] ml-[50px] mx-auto flex gap-10 flex-col">
              <span className="text-xl font-medium w-full mx-auto max-w-2xl">
                {props?.categorydata?.name}
              </span>
              <span className="text-base font-medium w-full mx-auto max-w-2xl">
          ...
          <div className="mx-auto max-w-2xl">
                ...
                <div className="grid sm:grid-cols-2 gap-15 lg:grid-cols-4 ms:grid-cols-1 ms:gap-15">
                  ...
                  /> */}
                      ...
                      <input
                        ...
                        className="outline-none  lg:w-[184px] md:w-[265px] ms:w-[138px] text-14 "
                      />
                    </div>
            ...
            <div className="grid sm:grid-cols-2 mt-20 gap-30 md:grid-cols-3 lg:grid-cols-4 ms:grid-cols-1 mx-10">
              {totalRecords > 0 &&
