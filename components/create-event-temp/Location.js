            ...
            {activeEventsTab.tab === 2 && (
              <div className="flex flex-col">
                ...
                <InputField
                  ...
                  inputstyle="block w-full focus:outline-none disabled:text-brand-disabled placeholder:placeholder-dropdownplaceholder placeholder:text-sm placeholder:font-normal placeholder:tracking-tight placeholder:bg-transparent px-5"
                />
              </div>
            )}
            {activeEventsTab.tab === 1 && (
              <div className="">
                {!location.lat && !location.lng && (
                  <>
                    <div
                      className={`flex items-center gap-[10px] py-3 max-w-[650px] border-0.5 rounded-5 px-10 ${
